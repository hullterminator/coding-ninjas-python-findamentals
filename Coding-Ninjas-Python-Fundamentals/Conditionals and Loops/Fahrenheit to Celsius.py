...
and Step Size (W),
you need to convert all Fahrenheit values from Start
to End at the gap of W, into their corresponding Celsius
...
The Fahrenheit value and its corresponding Celsius value should be
